...
public class HibernateCriteria {
    public static void main(String[] args) {
        ...
        query.select(from).orderBy(criteria.desc(from.get("nombre")), criteria.asc
                (from.get("apellido")));
        clientes = em.createQuery(query).getResultList();
        clientes.forEach(System.out::println);
        ...
        System.out.println("====== consulta de campos personalizados de entity cliente ======");
        ...
        System.out.println("====== consulta de campos personalizados de entity cliente con where ======");
        ...
        System.out.println("====== consulta de campos personalizados de entity cliente con where id ======");
